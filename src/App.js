    ...
    const onAddToCart = async (obj) => {
        try {
            ...
            if (findItem) {
                ...
                await axios.delete(`https://63136ed9a8d3f673ffcac9aa.mockapi.io/cart/${findItem.id}`);
            } else {
                setCartItems((prev) => [...prev, obj]);
                const { data } = await axios.post('https://63136ed9a8d3f673ffcac9aa.mockapi.io/cart', obj);
                setCartItems((prev) =>
                    prev.map((item) => {
        ...
        try {
            if (favorites.find((favObj) => Number(favObj.id) === Number(obj.id))) {
                ...
                const { data } = await axios.post(
                    'https://63136ed9a8d3f673ffcac9aa.mockapi.io/favorites',
                    obj,
                );
